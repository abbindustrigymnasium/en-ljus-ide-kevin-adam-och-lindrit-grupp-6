...
export default class Screen3 extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            Component15Visible: true,
            Component16Visible: true,
        }
                ...
                <View style={styles.screencontainer}>
                    ...
                    <View style={styles.screencontainerInner}>
                        ...
                        <Component14 
                            ...
                            hideComponent={ (component) => this.hideComponent(component) }
                            showComponent={ (component) => this.showComponent(component) }
                            visible={ this.state.Component14Visible }
                        />
                        <Component15 
                            navigation={this.props.navigation}
                            toggleComponent={ (component) => this.toggleComponent(component) }
                            hideComponent={ (component) => this.hideComponent(component) }
                            showComponent={ (component) => this.showComponent(component) }
                            visible={ this.state.Component15Visible }
                        />
                        <Component16 
                            navigation={this.props.navigation}
                            toggleComponent={ (component) => this.toggleComponent(component) }
                            hideComponent={ (component) => this.hideComponent(component) }
                            showComponent={ (component) => this.showComponent(component) }
                            visible={ this.state.Component16Visible }
                        />
